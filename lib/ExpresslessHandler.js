...
const fileNameString = Joi.string();
...
// Symbols
const methodsRef = Symbol('methodsRef');
const httpMethodRef = Symbol('httpMethodRef');
const httpRouteRef = Symbol('httpRouteRef');
...
class ExpresslessHandler {
    constructor(params, schema) {
        ...
        this[methodsRef] = [];
        this[httpRouteRef] = null;
        this[httpMethodRef] = null;

        this.flatten();
    }

    get httpMethod() {
        return this[httpMethodRef];
    }

    get httpRoute() {
        return this[httpRouteRef];
    }
    ...
    flatten() {
        ...
        this[httpMethodRef] = httpMethod;
        this[httpRouteRef] = httpRoute;
    ...
    extractParams(reqPath) {
        const routePath = this.httpRoute;
        const params = {};
        const requestPath = reqPath || '';
        ...
        // Short circuit so we don't have to iterate
    ...
    run(req, res) {
        return this.methods.reduce((p, fxn) =>
