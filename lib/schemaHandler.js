...
// Need to load the routes from the route of the folder
...
class ExpresslessHandler {
    constructor(params, schema) {
        ...
        this.defaultHandlers = params.defaultHandlers;
        this.methods = [];
    ...
    validateRequest(method, contentType) {
        ...
        if (method !== 'OPTIONS' && method !== routeMethod) {
            console.log(`Invalid method ${method}.. wanted ${routeMethod}`);
...
module.exports = {
    flatten(params) {
        ...
        const e = new ExpresslessHandler(params, s);
